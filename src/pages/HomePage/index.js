        ...
        <Container>
            ...
            <ServiceContainer image={ServiceImg}>
                ...
                <p>
                    ...
                    Для этого наша компания имеет современное оборудование для обработки древесины, резки и гибки металла и т.д.
                    Это позволяет минимизировать сроки поставок, защищает нас от срывов поставок, и уменьшает стоимость продукции.
                </p>
                <p>
                    Для того что бы рассчитать стоимость распила конкретного заказа свяжитесь с менеджером по одному из телефонов
                    <span> <a href="tel:+79991642590">+7 (999) 164-25-90</a> </span> и <span> <a href="tel:+79960475177">+7 (996) 047-51-77</a> </span>
